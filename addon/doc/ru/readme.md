...
* Исправлено: Исправлена проблема совместимости с NVDA 2022.1 и позднее.

## Изменения для 1.4

* Исправлено: Исправлена проблема совместимости с NVDA 2021.1 и позднее.

## Изменения для 1.3

* Исправлено: Исправлена проблема совместимости с новыми версиями NVDA.
